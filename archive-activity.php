...
<main class="site-main">
    <div class="page-header">
        <div class="container">
            <h1>THINGS TO DO</h1>
            <p>Deep sea fish, watch whales, kayak the west coast waves and savour our local cuisine. Nullam quis risus eget urna mollis ornare vel eu leo. Sed posuere consectetur est at lobortis.</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <section class="featured-listings">
            ...
            <div class="listings-grid">
                <?php
                $featured_activities = new WP_Query(array(
                    'post_type' => 'activity',
                    'posts_per_page' => 3,
                    'meta_query' => array(
                        array(
                            'key' => 'featured_activity',
                            'value' => '1',
                            'compare' => '='
                        )
                    )
        ...
        <section class="filter-section">
            <div class="filter-links">
                ...
                <button class="filter-button" data-filter="fishing">Fishing Charters</button>
                <button class="filter-button" data-filter="tours">Tours</button>
                <button class="filter-button" data-filter="restaurants">Restaurants, Pubs & Shops</button>
            </div>
        </section>
        ...
        <section class="all-listings">
            <div class="listings-grid">
                ...
                ?>
                    <p class="no-results">No activities found.</p>
                <?php endif; ?>
            </div>
        </section>
